...
import com.andre_luong.myruns5.database.ExerciseViewModel
import com.andre_luong.myruns5.model.ActivityType
...
import com.andre_luong.myruns5.util.ExerciseUtils.hoursToSeconds
import com.andre_luong.myruns5.util.ExerciseUtils.mpsToUnitType
import com.andre_luong.myruns5.util.ExerciseUtils.mToUnitType
import com.andre_luong.myruns5.util.SettingsUtils.getDistanceUnits
...
class MapDisplayActivity:
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        registerReceiver(
            locationReceiver,
            IntentFilter("com.andre_luong.myruns5.LOCATION_UPDATE"),
            RECEIVER_EXPORTED
        )
